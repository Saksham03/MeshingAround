...
public:
    ...
    bool Process(const ProcessOptions& options, const ObjLoader<uint32_t>& reader, ExportMesh& output);
    bool Extract(const ProcessOptions& options, const ObjLoader<uint32_t>& reader);
    void MeshletizeUsingOptimizedVertexBufferDataAndGenerateCullData(const ProcessOptions& options);
