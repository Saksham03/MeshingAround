...
struct Mesh
{
    ...
    std::vector<uint32_t>          MeshletIndicesToTessellate;
    ...
    void GetPrimitive(uint32_t index, uint32_t& i0, uint32_t& i1, uint32_t& i2) const
    {
        ...
        i0 = prim.indices.i0;//prim.i0;
        i1 = prim.indices.i1;//prim.i1;
        i2 = prim.indices.i2;//prim.i2;
    }
...
public:
    ...
    HRESULT CreateMeshletsFromFile(const wchar_t* filename);
